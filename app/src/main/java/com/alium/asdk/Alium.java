...
import com.alium.asdk.utils.MiscUtilities;
...
//        String manufacturer = Build.MANUFACTURER;
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            if (model.startsWith(manufacturer)) {
                ...
                Log.d("Build.MANUFACTURER","Build.MODEL -----------------:"+name);
               String names = manufacturer + " " + model;
                Log.d("Build.MANUFACTURER","  Build.MANUFACTURER --------------Build.MODEL -----------------:"+names);

            } else {
                name = manufacturer + " " + model;
                Log.d("Build.MANUFACTURER","  Build.MANUFACTURER --------------Build.MODEL -----------------:"+name);
            }
        }*/
...
//            System.out.println(address.getHostName());
            String hostname = address.getHostName(); // InetAddress.getLocalHost().getHostName();
            Log.d("Current_Host_Name :", "Host Name -----------------:" + hostname);
        }catch(Exception e){
            e.printStackTrace();
       }*/
       /*try {
           ...
           String hostname = (String) getString.invoke(null, "net.hostname");
           Log.d("Current_Host_Name :", "Host Name -----------------:" + hostname);
           String str = System.getProperties().getProperty("net.hostname"); //Properties.get("net.hostname");
           Log.d("Current_Host_Name :", "Host Name string -----------------:" + str);
       } catch (Exception ex) {
           ex.printStackTrace();
//           return defValue;
       }*/
...
/*
        ...
        try {
            ...
            Log.d("IP_ADDRESS", "IP-Address -----------------:" + ip);
